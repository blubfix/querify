    ...
    return (
        <PaperProvider>
                <Grid style={styles.container} container>
                        ...
                        <Col>
                            <View style={styles.gradientContainer}>
                                <LinearGradient colors={['#72479C', '#AF3139']} start={[0, 0]} end={[1, 0]} style={styles.linearGradient}>
                                    ...
                                    <Text style={styles.subHeaderTextInter}>Du hast deine querify-Erinnerung vollständig erstellt!</Text>
                                </LinearGradient>
                            </View>
                        </Col>
                    </Row>
                    <Row size={0.15}>
                        <Col>
                            <Text style={styles.subHeaderText}>
                                Teile deine Erinnerung jetzt mit deinen Freunden, Familienmitgliedern, Arbeitskollegen oder Kommilitonen!
                            </Text>
                        </Col>
                    </Row>
                    <Row>
                        <Col>
                            <Text style={styles.shareOptionsHeaderText}>Erinnerung URL</Text>
                        </Col>
                    </Row>
                    <Row size={0.15}>
                        <Col inline>
                    ...
                    <Row>
                        <Col>
                            <Text style={styles.shareOptionsHeaderText}>Erinnerung Eingabe-Code</Text>
                        </Col>
                    </Row>
                    <Row size={0.15}>
                        <Col inline>
